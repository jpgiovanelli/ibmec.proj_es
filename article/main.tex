...
\author{
  ...
  % Adicione o segundo autor aqui
  Autor Dois\inst{1}
}

\address{
  Departamento de Ciência da Computação\\
  Universidade XYZ -- Cidade, Estado, Brasil
  \email{\{joao.giovanelli, autor.dois\}@universidade.edu.br}
}
...
\url{https://github.com/[usuario]/proj_es}.
\end{abstract}

\begin{resumo}
Este artigo apresenta uma análise estatística abrangente de métricas de
código-fonte do framework JUnit, usando o \textit{GitHub Bug Dataset}~1.1.
Analisamos 1.154 classes Java com dez métricas selecionadas, aplicando
estatística descritiva, testes de normalidade, correlação e modelagem
por regressão linear e logística. Os resultados evidenciam forte
assimetria positiva, não-normalidade universal e um cluster
LOC--WMC--RFC com correlações acima de 0,88. O modelo logístico
para predição de avisos PMD severos alcança AUC de 0,744.
\end{resumo}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../output/figures/boxplots_all.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../output/figures/histograms.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../output/figures/scatter_plots.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.55\linewidth]{../output/figures/bar_dit.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../output/figures/outlier_boxplots.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../output/figures/qq_plots.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../output/figures/pairgrid_correlation.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{../output/figures/regression_diagnostics.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.60\linewidth]{../output/figures/logistic_roc_curve.png}
